	...
	var app = new Vue({
	  ...
	  computed: {
	    filteredList: function filteredList() {
	      ...
	      return this.list.filter(function (item) {
	        var searchRegex = new RegExp(self.filterText.replace(/[^a-zA-Z0-9 ]/g, ""), "i");
	  ...
	  created: function created() {
	    ...
	    _.forEach(src, function (v, k) {
	      _this.list = _this.list.concat(_.map(v, function (a) {
	        a.cat = k;
	    ...
	    _.forEach(this.cats, function (cat) {
	      _this.option.getFilterData[cat] = function (el) {
	        return el.cat === cat;
	      };
	    });
	  }
